...
<div class="body2">
  <div class="main">
        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <p class="pad_top2 pad_bot1"><strong>Hasil dari pencarian <?php echo "$_POST[txt_cari3]";?></strong></p><table id="table-tampil" border="1" cellpadding="5" cellspacing="0">
	<thead>
    	<tr>
        	<td>NIS</td>
        	<td>Id</td>
    ...
    <tbody>
    <?php 
	$query = mysql_query("select * from absen where nis like'%".$_POST['txt_cari3']."%'");
