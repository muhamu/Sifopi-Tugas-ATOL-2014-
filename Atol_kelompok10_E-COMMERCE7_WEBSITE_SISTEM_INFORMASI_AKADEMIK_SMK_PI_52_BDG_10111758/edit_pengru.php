    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">EDIT PENGGUNAAN RUANGAN</h2>
              <p class="pad_bot1 pad_top2">&nbsp;</p>
              <div align="justify">
                <p><strong> <img src="images/logo.png" width="272" height="84"></strong></p>
                <p>&nbsp;</p>
              </div>
              <div align="justify"><form name="update_data" action="proses_edit_pengru.php" method="post">
                <p><div class="wrapper">
                  <p class="pad_top2"><strong>Data Pengelolaan Ruangan</strong>
                  <p class="pad_top2">
                    <?php 
$id = $_GET['id'];

$query = mysql_query("select * from pelajaran_kelas where id='$id'") or die(mysql_error());
...
?>
                ...
                <tbody>
                  <tr>
                    <td>Id</td>
                    <td>:</td>
                    <td><input name="id" type="text" id="input2" value="<?php echo $data['id']; ?>" maxlength="20" required="required" /></td>
                  </tr>
                  <tr>
                    <td>Id Pel. Kelas</td>
                    <td>:</td>
                    <td><label>
                    <input name="id_pljrn_kelas" type="text" id="input3" value="<?php echo $data['id_pljrn_kelas']; ?>" maxlength="20" required="required" />
                    </label></td>
                  </tr>
                  <tr>
                    <td>Id Kelas</td>
	...
	?>
                  ...
                  <tr>
                    <td align="right" colspan="3"><input type="submit" name="submit2" value="simpan" id="submit2" /></td>
                  </tr>
                </tbody>
