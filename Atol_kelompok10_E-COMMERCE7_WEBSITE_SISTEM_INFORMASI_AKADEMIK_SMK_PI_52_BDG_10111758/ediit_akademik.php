        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <div align="justify"><form name="update_data" action="proses_edit_akademik.php" method="post">
                <p><div class="wrapper">
                  <p class="pad_top2"><strong>Data Kegiatan Akademik</strong>
                  <p class="pad_top2">
                <?php 
$id = $_GET['id'];

$query = mysql_query("select * from akademi where id='$id'") or die(mysql_error());
              ...
              <table border="0" cellpadding="5" cellspacing="0">
                <tbody>
                  ...
                  <tr>
                    <td>Nama Kegiatan</td>
                    <td>:</td>
                    <td><input name="nama" type="text" id="input1" value="<?php echo $data['nama']; ?>" maxlength="20" required="required" /></td>
                  </tr>
                  <tr>
                    <td>Tgl</td>
                    <td>:</td>
                    <td><input name="tgl" type="text" id="input1" value="<?php echo $data['tgl']; ?>" maxlength="100" required="required" /></td>
                  </tr>
                  <tr>
                    <td>Kegiatan</td>
                    <td>:</td>
                    <td><input name="kegiatan" type="text" id="input1" value="<?php echo $data['kegiatan']; ?>" required="required" /></td>
                  </tr>
                  <tr>
                    <td>Tgl Akhir</td>
                    <td>:</td>
                    <td><input name="tgl_akhir" type="text" id="input1" value="<?php echo $data['tgl_akhir']; ?>" required="required" /></td>
                  </tr>
                  <tr>
