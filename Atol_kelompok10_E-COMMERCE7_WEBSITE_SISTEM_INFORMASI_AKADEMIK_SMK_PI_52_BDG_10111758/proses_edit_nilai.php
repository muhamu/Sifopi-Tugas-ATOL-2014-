...
$query = mysql_query("update nilai set id='$id', no_induk='$no_induk', id_pelajaran='$id_pelajaran', tugas='$tugas', uts='$uts', uas='$uas', nilai_akhir='$nilai_akhir', id_kelas='$id_kelas', status='$status', semester='$semester' where id='$id'") or die(mysql_error());
