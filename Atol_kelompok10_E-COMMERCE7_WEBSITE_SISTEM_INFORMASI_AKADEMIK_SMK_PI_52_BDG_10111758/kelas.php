    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">DATA KELAS</h2>
              <p class="pad_bot1 pad_top2"><strong>Cari data Kelas:</strong>              </p>
...
?>
	...
	?>
    	<tr>
            ...
            <td>
            	<a href="ediit_kelas.php?id=<?php echo $data['id']; ?>">Edit</a> || 
	...
	?>
          ...
          <article class="col2 pad_left2">
            ...
            <div class="wrapper">
              <p class="pad_top2"><form name="input_data_kelas" action="insert_kelas.php" method="post">
