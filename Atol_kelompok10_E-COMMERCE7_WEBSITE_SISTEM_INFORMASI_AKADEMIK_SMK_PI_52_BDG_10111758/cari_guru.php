...
<html lang="en">
<head>
<title>Hasil Pencarian Guru | SMK Prakarya Internasional 52 Bandung</title>
<meta charset="utf-8">
...
<div class="body2">
  <div class="main">
    ...
    <tbody>
    <?php 
	$query = mysql_query("select * from guru where nama like'%".$_POST['txt_cari']."%'");
	...
	?>
    	<tr>
        	...
        	<td colspan="2"><a href="ediit_guru.php?id=<?php echo $data['id']; ?>">Edit</a> || <a href="delete_kelas.php?id=<?php echo $data['no_induk']; ?>">Hapus</a></td>
            </tr>
    <?php 
		$no++;
	} 
