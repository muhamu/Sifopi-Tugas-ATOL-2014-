...
<html lang="en">
<head>
<title>Hasil Pencarian Lain Pembayaran | SMK Prakarya Internasional 52 Bandung</title>
<meta charset="utf-8">
...
<div class="body2">
  <div class="main">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">DATA PEMBAYARAN</h2>
    ...
    <tbody>
    <?php 
	$query = mysql_query("select * from pembayaran_lain where no_induk like'%".$_POST['txt_cari']."%'");
...
<p><a href="pembayaran_lain.php">kembali ke data pembayaran lain&gt;&gt;</a></p>
            </div>
            <div class="pad_left1">
