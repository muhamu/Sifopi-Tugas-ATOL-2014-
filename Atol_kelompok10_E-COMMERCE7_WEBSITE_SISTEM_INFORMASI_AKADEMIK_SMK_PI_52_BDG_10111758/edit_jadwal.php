        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <div align="justify"><form name="update_data" action="proses_edit_jadwal.php" method="post">
                <p><div class="wrapper">
                  <p class="pad_top2"><strong>Data Jadwal</strong>
                  <p class="pad_top2">
                    <!--<?php 
$id_jadwal = $_GET['id_jadwal'];

$query = mysql_query("select * from jadwal where id_jadwal='$id_jadwal'") or die(mysql_error());

$data = mysql_fetch_array($query);
?>-->
                    <input type="hidden" name="id2" value="<?php echo $id_jadwal; ?>" />
                  ...
                  <table border="0" cellpadding="5" cellspacing="0">
                    <tbody>
                      <tr>
                        <td>Id jadwal</td>
                        <td>:</td>
                        <td><input name="id_jadwal" type="text" id="input4" maxlength="20" required="required" /></td>
                      </tr>
                      <tr>
                        <td>Id Pel. Kelas</td>
                        <td>:</td>
	...
	?>
                      ...
                      <tr>
                        <td>Jam</td>
                        <td>:</td>
                        <td><input name="jam" type="text" id="input5" maxlength="20" required="required" /></td>
                      </tr>
                      <tr>
