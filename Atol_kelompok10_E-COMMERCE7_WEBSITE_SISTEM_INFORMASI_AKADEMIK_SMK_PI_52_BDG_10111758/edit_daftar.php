        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <div align="justify"><form name="update_data" action="proses_edit_daftar.php" method="post">
                <p><div class="wrapper">
                  <p class="pad_top2"><strong>Data Pendaftar</strong>
                  <p class="pad_top2">
                <?php 
$id = $_GET['id'];

$query = mysql_query("select * from daftar where id='$id'") or die(mysql_error());
                  ...
                  <table border="0" cellpadding="5" cellspacing="0">
                    <tbody>
                      ...
                      <tr>
                        <td>Tgl Daftar</td>
                        <td>:</td>
                        <td><input name="tgl_daftar" type="text" id="input1" value="<?php echo $data['tgl_daftar']; ?>" maxlength="100" required="required" /></td>
                      </tr>
                      <tr>
