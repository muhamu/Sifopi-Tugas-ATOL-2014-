    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">EDIT KELAS</h2>
...
$query = mysql_query("select * from kelas where id='$id'") or die(mysql_error());

$data = mysql_fetch_array($query);
?>

<form name="update_data" action="proses_edit_kelas.php" method="post">
  ...
  <table border="0" cellpadding="5" cellspacing="0">
    <tbody>
		...
		<tr>
		  <td>Wali</td>
		  <td>:</td>
		  <td><input name="wali" type="text" id="wali" value="<?php echo $data['wali']; ?>" maxlength="100" required="required" /></td>
		  </tr>
    	
		<tr>
        	<td>No. Ruangan</td>
        	<td>:</td>
        	<td><input name="no_ruangan" type="text" id="no_ruangan" value="<?php echo $data['no_ruangan']; ?>" maxlength="100" required="required" /></td>
        </tr>
    	
		<tr>
        	<td>Id Kelas</td>
        	<td>:</td>
        	<td><input name="id_kelas" type="text" id="id_kelas" value="<?php echo $data['id_kelas']; ?>" required="required" /></td>
        </tr>
    	<tr>
        	<td>Tahun Ajaran</td>
        	<td>:</td>
        	<td><input name="ajaran" type="text" id="ajaran" value="<?php echo $data['ajaran']; ?>" maxlength="14" required="required" /></td>
        </tr>
    </tbody>
</table>
              <p>&nbsp;</p>
