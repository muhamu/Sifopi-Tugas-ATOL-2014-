...
<html lang="en">
<head>
<title>Status Pendaftaran | SMK Prakarya Internasional 52 Bandung</title>
<meta charset="utf-8">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">STATUS PENDAFTAR</h2>
...
?>
    ...
    <tbody>
    <?php 
	$query = mysql_query("select * from seleksi");
	...
	?>
    	<tr>
        	...
        	<td>
            	<a href="edit_statdaf.php?id=<?php echo $data['id']; ?>">Edit</a> || 
	...
	?>
          ...
          <article class="col2 pad_left2">
            ...
            <div class="wrapper">
              <p class="pad_top2"><form name="input_data_kelas" action="insert_status.php" method="post">
<table border="0" cellpadding="5" cellspacing="0">
  <tbody>
	...
	while ($data = mysql_fetch_array($query)) 
	{
	echo "<option value=".$data['id'].">".$data['id']."<br>";
	}
	?>
            </select></td>
    </tr>
    ...
    <tr>
      <td>Tgl Masuk</td>
      <td>:</td>
      <td><input id="input2" type="text" name="tgl_masuk" maxlength="100" required="required" /></td>
    </tr>
    <tr>
