...
<html lang="en">
<head>
<title>Hasil Pencarian Peng. Ruangan | SMK Prakarya Internasional 52 Bandung</title>
<meta charset="utf-8">
    ...
    <section id="content">
      <div class="box1">
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              <h2 class="pad_bot1">DATA PENGGUNAAN RUANGAN</h2>
              <p class="pad_top2 pad_bot1"><strong>Hasil dari pencarian <?php echo "$_POST[txt_cari2]";?></strong></p>
...
<p><a href="cari_guru.php">kembali ke data penggunaan ruangan&gt;&gt;</a></p>
            </div>
            <div class="pad_left1">
