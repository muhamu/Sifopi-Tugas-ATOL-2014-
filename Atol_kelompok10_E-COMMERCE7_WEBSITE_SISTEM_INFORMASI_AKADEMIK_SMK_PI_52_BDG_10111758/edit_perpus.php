    ...
    <div class="box1">
      <div class="wrapper">
        ...
        <div class="pad_left1">
          ...
          <div align="justify">
            <form name="update_data" action="proses_edit_perpus.php" method="post">
            <p>
<div class="wrapper">
...
$query = mysql_query("select * from buku_perpustakaan where id_buku='$id_buku'") or die(mysql_error());
